...
<div class="container">
  ...
  <form action="user.edit.proc.php" method="post" enctype="multipart/form-data">
    ...
    <div class="mb-3">
      ...
      <input type="text" class="form-control" id="customerName" name="customerName" value="<?php echo $row['c_name'];?>" disabled>
    </div>
    <div class="row">
    <div class="col-6 mb-3">
      <label for="customerGender" class="form-label">เพศ</label>
      <input type="text" class="form-control" id="customerGender" name="customerGender" value="<?php echo $row['c_gender'];?>" disabled>
    </div>
    <div class="col-6 mb-3">
      <label for="customerAge" class="form-label">อายุ</label>
      <input type="text" class="form-control" id="customerAge" name="customerAge" value="<?php echo $row['c_age'];?>" disabled>
    </div>
    <div class="mb-3">
      <label for="customerTel" class="form-label">เบอร์โทรศัพท์</label>
      <input type="text" class="form-control" id="customerTel" name="customerTel" value="<?php echo $row['c_tel'];?>" disabled>
    </div>
    <div class="mb-3">
      <label for="customerAddress1" class="form-label">ที่อยู่ลำดับที่ 1</label>
      <input type="text" class="form-control" id="customerAddress1" name="customerAddress1" value="<?php echo $row['c_addr1'];?>" disabled>
    </div>
    <div class="mb-3">
      <label for="customerAddress2" class="form-label">ที่อยู่ลำดับที่ 2</label>
      <input type="text" class="form-control" id="customerAddress2" name="customerAddress2" value="<?php echo $row['c_addr2'];?>" disabled>
    </div>
    <div class="mb-3">
      <label for="customerAddress3" class="form-label">ที่อยู่ลำดับที่ 3</label>
      <input type="text" class="form-control" id="customerAddress3" name="customerAddress3" value="<?php echo $row['c_addr3'];?>" disabled>
    </div>
    <div class="text-center mb-3">
        <a href="user.edit.php?id=<?php echo $_SESSION['userId']?>" class="btn btn-primary">แก้ไขข้อมูลประวัติส่วนตัว</a>
    </div>
    </form>
</div>
</div>
